    ...
    return (
        <div className="p-6 space-y-4">
            ...
            <p className="text-sm text-gray-500">
                Du kannst Nova hier aktivieren oder deaktivieren.
            </p>
            <button
                onClick={toggleNova}
                className={`px-4 py-2 rounded text-white shadow ${enabled ? "bg-red-500 hover:bg-red-600" : "bg-green-600 hover:bg-green-700"
                    }`}
            >
